...
movie6 = Movie.new("Die Another Day")
...
ep1 = Episode.new(show1, "BBT Episode 1")
ep2 = Episode.new(show1, "BBT Episode 2")
ep3 = Episode.new(show1, "BBT Episode 3")
ep4 = Episode.new(show2, "Sex and the City Episode 1")
ep5 = Episode.new(show3, "Young Sheldon Episode 1")
ep6 = Episode.new(show3, "Young Sheldon Episode 2")

ec1 = EpisodeCharacter.new(ep1, character7)
ec2 = EpisodeCharacter.new(ep1, character8)
ec3 = EpisodeCharacter.new(ep1, character9)
ec4 = EpisodeCharacter.new(ep2, character7)
ec5 = EpisodeCharacter.new(ep2, character8)
ec6 = EpisodeCharacter.new(ep2, character9)
ec7 = EpisodeCharacter.new(ep5, character8)
ec8 = EpisodeCharacter.new(ep6, character8)
ec9 = EpisodeCharacter.new(ep3, character5)
ec10 = EpisodeCharacter.new(ep3, character7)
ec11 = EpisodeCharacter.new(ep3, character8)
ec12 = EpisodeCharacter.new(ep3, character9)
...
mc5 = MovieCharacter.new(movie6, character6)
